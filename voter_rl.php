...
$idjeu = 3; // Rocket League
$now   = date('Y-m-d H:i:s');

/* --- Vérifier qu'il existe AU MOINS un scrutin RL OUVERT --- */
...
/* --- Compétitions RL qui ont un scrutin OUVERT --- */
...
<?php if (empty($competitions)): ?>
    <div class="scrutin-info">
        <p>Aucune compétition Rocket League ouverte au vote pour le moment.</p>
    </div>
<?php endif; ?>
