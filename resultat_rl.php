...
<div class="about-us">
    <img src="images/rocketleague.jpg" alt="Rocket League" width="384" height="216">
    <h1>Résultats - Rocket League</h1>
    <p>Découvrez les résultats des scrutins clôturés pour Rocket League.</p>
</div>
...
<?php if (empty($scrutins)): ?>
    ...
    <div class="scrutin-info">
        ...
        <p>Aucun scrutin Rocket League clôturé n’a encore été traité.</p>
    </div>
